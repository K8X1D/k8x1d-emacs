...
;; From https://github.com/Lambda-Emacs/lambda-emacs/blob/main/lambda-library/lambda-setup/lem-setup-splash.el
...
(defcustom lem-splash-banner
  "
    'codddddo;                 ,lddddddc                 'codddddo;                  
     ,o0XXXXX0d;               :0XXXXXXk,               :kKXXXXKkc                   
       ,o0XXXXX0o,             :0XXXXXXk,             :xKXXXXKOl'                    
         ;d0XXXXXOl'           :0XXXXXXk,           ;d0XXXXXOl'                      
           ;xKXXXXKOl'         :0XXXXXXk,         ,d0XXXXX0o,                        
             :kKXXXXKkc        :0XXXXXXk,       ,o0XXXXX0d;                          
              'ckKXXXXKk:      :0XXXXXXk,     'lOKXXXX0x;                            
                'lOKXXXXKx;    :0XXXXXXk,   'ckKXXXXKx:                              
                  ,dKXXXXX0d;  :0XXXXXXk,  :kKXXXXX0l                                
                  ;xKXXXXXXX0o,c0XXXXXXk;;xKXXXXXXXKo'                               
                 cOXXXXXXXXXXXOOKXXXXXX0k0XXXXXXXXXXKx;                              
               'o0XXXXKkoxKXXXXXXXXXXXXXXXXXX0doOXXXXXOc                             
              ;xKXXXXKd,  :kKXXXXXXXXXXXXXX0d;  ;kKXXXX0o'                           
             cOXXXXXOl      ckKXXXXXXXXXX0x;     'dKXXXXKx;                          
           'o0XXXXKk;        'lOXXXXXXXKx:         cOXXXXXOc                         
          ;xKXXXXKd,           c0XXXXXXk,           ;kKXXXX0o'                       
         cOXXXXX0l             :0XXXXXXk,            ,dKXXXXKx;                      
       'o0XXXXXk:              :0XXXXXXk,              l0XXXXXOc                     
      ;xKXXXXKd,               :0XXXXXXk,               ;kKXXXXKo'                   
     cOXXXXX0l                 :0XXXXXXk,                ,dKXXXXKx;                  
   'oKXXXXKk;                  :0XXXXXXk,                  l0XXXXXOc                 
  ,xKKKKK0d,                   :OKKKKKKx,                   :kKKKKK0o'               
  ';:;:::;                      ;::;;::,                     ';:::::;'               
"
  ...
  (or (when (get-buffer "*splash*")
      ...
      (let* ((splash-buffer (get-buffer-create "*splash*")))
        ...
        (let* ((buffer-read-only t)
	       ...
	       ;;(image (lem-get-string-from-file "~/Downloads/banner.txt"))
	       )
