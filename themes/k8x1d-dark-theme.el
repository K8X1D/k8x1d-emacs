...
(defvar k8x1d-dark-colours-alist
  nil
  "Colours for the k8x1d (dark) theme")

(setq k8x1d-dark-colours-alist
      '((white . "#ebdbb2")
        (black . "#282828")
	(pale-black . "#504945")
	(pale-white . "#bdae93")
...
(defun k8x1d-dark-colour (name)
  "Shortcut to get a colour for ``k8x1d-dark-colours-alist'' by NAME."
  (cdr (assoc name k8x1d-dark-colours-alist)))

(let* ((*bg*         (k8x1d-dark-colour 'black))
       (*bg-alt*         (k8x1d-dark-colour 'pale-black))
       (*fg*             (k8x1d-dark-colour 'white))
       (*fg-alt*             (k8x1d-dark-colour 'pale-white))
       )
