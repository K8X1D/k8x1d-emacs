...
(defvar k8x1d-lightcolours-alist
  nil
  "Colours for the k8x1d (light) theme")

(setq k8x1d-light-colours-alist
      '((white . "#ebdbb2")
        (black . "#282828")
	(pale-black . "#504945")
	(pale-white . "#bdae93")
...
(defun k8x1d-light-colour (name)
  "Shortcut to get a colour for ``k8x1d-light-colours-alist'' by NAME."
  (cdr (assoc name k8x1d-light-colours-alist)))

(let* ((*fg*         (k8x1d-light-colour 'black))
       (*fg-alt*         (k8x1d-light-colour 'pale-black))
       (*bg*             (k8x1d-light-colour 'white))
       (*bg-alt*             (k8x1d-light-colour 'pale-white))
       )
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-string-face ((t (:foreground "#EBE9E7" :background, *bg-alt*))))
